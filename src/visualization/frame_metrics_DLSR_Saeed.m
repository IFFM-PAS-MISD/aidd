...
list1 = {'Saeed_Pearson_CC_exp_512_frames.csv'};
list2 = {'Saeed_PSNR_exp_512_frames.csv'}; 
...
for k = 1:nFile
    filename1 = list1{k};
    filename2 = list2{k};
    processed_filename = ['frame_metrics_DLSR_model_',num2str(k+1)]; % filename of processed .mat data
