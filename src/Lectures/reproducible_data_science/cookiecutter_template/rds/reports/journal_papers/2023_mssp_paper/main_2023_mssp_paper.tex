...
%\graphicspath{{figs/}{reports/journal_papers/2023_mssp_paper/figs/}}
\graphicspath{{figs/}}
...
\begin{document}
	...
	\begin{abstract}
		\input{2023_mssp_paper_abstract}
	\end{abstract}
	...
	\end{frontmatter}
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	\input{2023_mssp_paper_introduction}
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	\input{2023_mssp_paper_methodology}
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	\input{2023_mssp_paper_results}
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	\input{2023_mssp_paper_conclusions}
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\bibliography{2023_mssp_paper_bibliography}
