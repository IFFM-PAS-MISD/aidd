...
selected_frames={200:320,200:300,200:290,200:280}; % selected frames for Hilbert transform
...
%                    unwrapped_phase_flat_smooth = movmean(unwrapped_phase_flat,10);
                ...
                amplitude_by_angle_smoothed = movmean(amplitude_by_angle,8,1);
                for n_angle=1:number_of_angles
...
%%{
            fgh_m=figure('Position',[1 1 1920 1000]);         
            c=0;
            for frame = selected_frames{k-1}  
                c=c+1;
                subplot(1,2,1);
                ...
                %caxis([200 800]); 
                %caxis([-100 500]); 
                title(['Wavenumbers fn= ',num2str(frame),' ',num2str(freq_list(k-1)),' kHz']);
