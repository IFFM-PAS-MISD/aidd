...
# Loading the dataset
#####################################
x = np.load('E:/datasets/augemented/Augmented_data_segmentation.npy')
x = x / 255.
x = x.reshape(1900, 512, 512, 1)
y = np.load('E:/datasets/augemented/Augmented_target_segmentation.npy')
y = y / 255.
...
Conv  = Conv2D(filters,filterSize,padding='same',activation='relu')(Conv)
Conv  = Conv2D(filters,filterSize,padding='same',activation='relu')(Conv)
print(Conv.shape)
...
print(red.shape)
red = Conv2D(64,(1,1), dilation_rate=2, padding='same')(red)
...
orange = Conv2D(32,(1,1), dilation_rate=2, padding='same')(orange)
...
blue = Conv2D(32,(1,1), dilation_rate=2, padding='same')(blue)
...
green = Conv2D(32,(1,1), dilation_rate=2, padding='same')(green)
