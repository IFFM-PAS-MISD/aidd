...
model.fit(np.array(x_train), np.array(y_train), shuffle=True, batch_size=8, epochs=epochs, validation_split=0.2)
score = model.evaluate(test_x_samples, tests_y_samples, verbose=0)
print('Test loss:', score[0])
print('Test accuracy:', score[1])
model.summary()
model.save('Sgd_updated unet_adding_16_filters_ConvsTrans.h5')
