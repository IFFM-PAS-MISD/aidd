...
def func(path):
    ...
    for fn in img_names:
       ...
       # crop = crop_image(crop_img)
        imge_mat.append(crop_img)
    return imge_mat


# Dividing the image into squares of 32*32 size #49 squares
...
# Training the model
model.fit(Training_IMG, Label_Train, validation_data=(Test_IMG, Label_Test), epochs=5)
predections = model.predict(Test_IMG)
