...
%%}            
            % selected frames
            RMS_wavenumbers_selected = sqrt(sum(wavenumbers.^2,3,'omitnan'))/length(selected_frames);
            ...
            processed_filename = ['A0stop_L3_S4_B_RMS_wavenumbers_selected_',filename]; % filename of processed .mat data
            print([figure_output_path,processed_filename],'-dpng', '-r600'); 
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            % Mean wavenumbers
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%             end
            ...
            processed_filename = ['A0stop_L3_S4_B_Mean_wavenumbers_selected_',filename]; % filename of processed .mat data
...
%             end
            ...
            processed_filename = ['A0stop_L3_S4_B_Mean_wavenumbers_selected_smooth_',filename]; % filename of processed .mat data
            ...
            processed_filename = ['A0stop_L3_S4_B_RMS_amplitude_selected_',filename]; % filename of processed .mat data
            ...
            processed_filename = ['A0stop_L3_S4_B_Mean_amplitude_selected_',filename]; % filename of processed .mat data
...
%                             Thickness_map(i,j) = thickness(J);
                ...
                set(gcf,'PaperPositionMode','auto');
                drawnow;       
                processed_filename = ['A0stop_L3_S4_B_Thickness_map_',filename]; % filename of processed .mat data     
                print([figure_output_path,processed_filename],'-dpng', '-r600');
