...
list = {'chirp_interp','Data50_packet_interp','Data100_packet_interp','Data150_packet_interp','Data200_packet_interp'};
freq_list =[50,100,150,200]; % frequency list in kHz according to files above (max 4 frequencies)
