...
%overwrite=false;
overwrite=true;
test_case=[5,6,7]; % select file numbers for processing
...
raw_data_path = fullfile(filesep,filesep, 'odroid-laser','laser', 'lamb_opt','data','raw','exp', 'CFRP_120_quarter',filesep );

% create path to the experimental interim data folder
interim_data_path = fullfile( projectroot, 'data','interim','exp', filesep );

% full field measurements
list = {'497x497p_2-5kHz_5HC_x1_15Vpp', ...          % 1  Length = ?;Width = ?;           
        '497x497p_5kHz_5HC_x3_15Vpp', ... % 2
        '497x497p_10kHz_5HC_x3_15Vpp', ... % 3
        '497x497p_16_5kHz_5HC_x5_15Vpp', ... % 4
        '497x497p_50kHz_5HC_x20_15Vpp', ... % 5
        '497x497p_100kHz_5HC_x20_15Vpp', ... % 6
        '497x497p_150kHz_5HC_x20_12Vpp', ... % 7
        '497x497p_200kHz_5HC_x20_12Vpp_filtered', ... % 8
        '497x497p_chp200_x40_6Vpp_250kHz_max', ... % 9
        '497x497p_chp200_x40_6Vpp_1500kHz_max', ... % 10
        '497x497p_hann_5us_x40_20Vpp_250kHz_max', ... % 11
         };              
...
for k = test_case
    filename = list{k};
    processed_filename = ['RMS_baseline_',filename]; % filename of processed .mat data
