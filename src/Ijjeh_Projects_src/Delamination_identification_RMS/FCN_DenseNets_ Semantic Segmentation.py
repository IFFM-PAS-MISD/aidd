...
def DenseNet_Model(x_train_set, y_train_set, DB_Num):
    ...
    segment_model.compile(optimizer='adam',
                          ...
                          metrics=[iou_metric])
    ####################################################################################################################
    segment_model.fit(np.asarray(x_train_set),
                      np.asarray(y_train_set),
...
model.save('E:/backup/models/FCN_DenseNet_models/FCN_Dense_net_IoU_100_epoches_.h5')
