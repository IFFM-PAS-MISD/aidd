...
model_name = 'GCN_model_K_7_fold_1.h5'
...
unet_num_csv = 'GCN_kfold_num_softmax_iou.csv'
unet_exp_csv = 'GCN_kfold_exp_softmax_iou.csv'
...
path_FCN_DenseNet_Num_figs_softmax = 'GCN/num'

########################################################################################################################
# paths to folders to save the output Exp images
########################################################################################################################
path_FCN_DenseNet_Exp_figs_softmax = 'GCN/exp'
