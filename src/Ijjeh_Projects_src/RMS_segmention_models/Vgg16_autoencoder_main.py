...
model_name = 'updated_VGG16_encoder_decoder_kfold_softmax_trial_3.h5'
...
unet_num_csv = 'VGG16_autoencoder_kfold_num_softmax_iou.csv'
unet_exp_csv = 'VGG16_autoencoder_kfold_exp_softmax_iou.csv'
...
path_FCN_DenseNet_Num_figs_softmax = 'VGG16_encoder_decoder/num'

########################################################################################################################
# paths to folders to save the output Exp images
########################################################################################################################
path_FCN_DenseNet_Exp_figs_softmax = 'VGG16_encoder_decoder/exp'
...
img_numerical = 'VGG16_autoencoder_'
