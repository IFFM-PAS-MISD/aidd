...
model_name = 'updated_PSPNet_kfold_softmax_BN_trial_2.h5'
...
unet_num_csv = 'PSPNet_kfold_num_softmax_iou.csv'
unet_exp_csv = 'PSPNet_kfold_exp_softmax_iou.csv'
...
path_FCN_DenseNet_Num_figs_softmax = 'PSPNet/num'

########################################################################################################################
# paths to folders to save the output Exp images
########################################################################################################################
path_FCN_DenseNet_Exp_figs_softmax = 'PSPNet/exp'
