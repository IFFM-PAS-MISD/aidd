...
model_name = 'updated_Unet_kfold_softmax_trial_2.h5'
...
path_unet_Numerical_figures_softmax = 'UNet/num'

########################################################################################################################
# paths to folders to save the output Exp images
########################################################################################################################
path_unet_Exp_figures_softmax = 'UNet/exp'
...
img_numerical = 'UNet_num_'

if __name__ == '__main__':
    os.chdir(Thesis_new_path + path_unet_Numerical_figures_softmax)
    Testing(unet_num_csv, img_numerical)

    # os.chdir(Thesis_new_path + path_unet_Exp_figures_softmax)
    # exp(unet_exp_csv)
