	...
	\begin{frame}{Motivations}
		\begin{columns}[T]
			\begin{column}[t]{.5\textwidth}
				\begin{figure}[c]
					\centering
					\includegraphics[width=0.8\textwidth]{Composite_advantages.png}					
				\end{figure}			
				\begin{figure}[c]
					\includegraphics[width=0.65\textwidth]{delaminated_plate1.jpg}
				\end{figure}
				\begin{small}
					\justifying
...
%	\subsection{Developed DL models}
	...
	\setcounter{subfigure}{0}
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	\begin{frame}{Development environment: Tools}
		All developed DL models were \alert{hard-coded (in-house)} \\
		\alert{(Tailored specifically to meet the task requirements)} 
		\begin{itemize}			
		...
		\end{itemize}
	\end{frame}
	\begin{frame}{Development environment: Data preprocessing}	
		\begin{columns}[T]
			\begin{column}[t]{0.48\textwidth}
				\begin{enumerate}			
					\item Data normalisation.
					\item Data augmentation.
					\item Applying cross-validation.
					\item Dataset was divided into two portions: \(80\%\) training set and	\(20\%\) testing set. 
			...
			\begin{column}[t]{0.48\textwidth}
				...
				\begin{enumerate}
					\item Learning rate
					\item Momentum
					\item Optimisation technique (SGD, Adam, RMSProp, $\dots$)
					\item Drop rate
					\item Batch size
					\item Number of Epochs
					\item Objective loss function (MSE, BCE, CCE, $\dots$)
				\end{enumerate} 
			Trail and error and manual search was utilised for tuning the hyperparameters	
			\end{column}
