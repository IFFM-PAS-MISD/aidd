...
\author{\textbf{Ph.D. candidate: Eng. Abdalraheem A. Ijjeh } 
	\and \\ \textbf{Supervisor: D.Sc. Ph.D. Eng. Paweł Kudela}} 
...
%			\end{alertblock}
	...
	\note
	{
		My main objective in this work is to develop an artificial intelligence-driven diagnostic system for delamination identification in composite laminates.
		
		The secondary objective is to address the issue of slow data acquisition of high-resolution measurements full wavefields by a scanning laser Doppler vibrometer.
	...
	{		
		...
		Additionally, to address the issue of slow data acquisition by the scanning laser Doppler vibrometer, I have developed a deep learning model that can recover the high-resolution measurements of the full wavefield from low-resolution measurements.
...
%			\quad
		...
		\noindent\textbf{I chose the hardest task: 
			\\ 
