	...
	\begin{frame}{Motivations}
		\begin{columns}[T]
			\begin{column}[t]{.5\textwidth}
				\begin{figure}[t]
					\centering
					\includegraphics[width=.85\textwidth]{Composite_advantages.png}					
				\end{figure}			
				\begin{figure}[t]
					\includegraphics[width=.75\textwidth]{delaminated_plate1.jpg}
				\end{figure}
				\begin{small}
					\justifying
			...
			\begin{column}[t]{0.5\textwidth}
				\begin{figure}[t]
					\includegraphics[width=0.9\textwidth]{Crashes.png}
				\end{figure}
			\end{column}
		\end{columns}
	\end{frame}
