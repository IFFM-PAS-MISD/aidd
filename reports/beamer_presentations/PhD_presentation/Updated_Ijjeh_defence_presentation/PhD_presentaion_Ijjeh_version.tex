	...
	\begin{frame}{Motivations}
		\begin{columns}[T]
			\begin{column}[t]{.4\textwidth}
				\begin{figure}[t]
					\centering
					\includegraphics[width=.9\textwidth]{Composite_advantages.png}					
				\end{figure}			
				\begin{figure}[t]
					\includegraphics[width=.90\textwidth]{delaminated_plate1.jpg}
				\end{figure}
				\begin{small}
					\justifying
			...
			\begin{column}[t]{0.6\textwidth}
				\begin{figure}[t]
					\includegraphics[width=0.7\textwidth]{Crashes.png}
				\end{figure}
			\end{column}
		\end{columns}
	\end{frame}
			...
			\begin{column}[t]{0.7\textwidth}
				\begin{table}[t]
					...
					\resizebox{1\textwidth}{!}{%
						\begin{tabular}{lccc}
							\toprule[1.5pt]
							& \multicolumn{2}{c}{Delamination identification} & \multirow{2}{*}{Super-resolution image reconstruction} \\ \cmidrule(lr){2-3}
				...
				\end{table}
				\begin{itemize}
					\item Trail and error and manual search was utilised for tuning the hyperparameters.
					\item Early stopping technique was applied to prevent overfitting. 
				\end{itemize}
			\end{column}
...
%		We can see that the models can identify the delamination with almost free noise indicating the models are capable of generalising and detecting the delamination on previously unseen data. 
	...
	\begin{frame}{Experimental results full wavefield based (Multiple delaminations)}
		\begin{columns}[T]
			\begin{column}[t]{0.2\textwidth}
				\begin{alertblock}{Full wavefield}
					\begin{figure}[t]
						\centering
						\subfloat[512 frames]{\animategraphics[autoplay,loop,height=0.25\textheight]{32}{figures/gif_figs/input_specimen_3/specimen_3-}{1}{512}}
					\end{figure}
				\end{alertblock}				
			\end{column}	
%			\quad				
			\begin{column}[t]{0.4\textwidth}				
				\begin{exampleblock}{Adaptive wavenumber filtering}
					\footnotesize
					\justifying
					IoU$=0.04$
					\begin{figure}[t]
						\centering
						\subfloat[]{\includegraphics[height=0.25\textheight]{figures/mul/figure17a.png}}
						\quad
						\centering
						\subfloat[]{\includegraphics[height=0.25\textheight]{figures/mul/figure17b.png}}								
					\end{figure}
				\end{exampleblock}	
			\end{column}
			\begin{column}[t]{0.4\textwidth}				
				\begin{block}{DL approach}	
					\footnotesize
					\justifying
					 IoU= $0.64$ and $\epsilon=1.69\%$				
					\begin{figure}[c]
						...
						\\
						\subfloat[]{\includegraphics[width=0.8\textwidth,keepaspectratio]{figures/RMS_BInary_RMS.png}}
%						\quad						
		...
		\begin{columns}[T]
			\begin{column}[t]{0.6\textwidth}
				...
				\begin{exampleblock}{Compressive sensing (CS) theory}
					...
					\begin{figure}
						\centering
						\includegraphics[width=.6\textwidth]{matrix_mask.png}
					\end{figure}
				\end{exampleblock}	
	...
	\begin{frame}{Experimental test case}		
		\begin{columns}[T]
			\begin{column}[c]{0.25\textwidth}
				\footnotesize
				LR measurements (Input): \(32\times32=1024\) points. \\
				HR (Output): \(512\times512=262144\) points.
				\begin{figure}	
					\centering					
			...
			\begin{column}[c]{0.75\textwidth}
				\begin{figure}[]
					\centering
					\subfloat[HR ref]{\includegraphics[height=.3\textheight]{figure10a.png}}\quad
					\subfloat[CS: 1024 points]{\includegraphics[height=.3\textheight]{figure10b.png}}\quad
...
%					\subfloat[CS: 4000 points]{\includegraphics[height=.22\textheight]{figure10d.png}}\quad
					\subfloat[DLSR]{\includegraphics[height=.3\textheight]{figure10e.png}}\quad
					
					\subfloat[Ref]{\includegraphics[height=.3\textheight]{figure11a.png}}\quad
					\subfloat[CS: 1024 points]{\includegraphics[height=.3\textheight]{figure11b.png}}\quad
...
%					\subfloat[CS: 4000 points]{\includegraphics[height=.22\textheight]{figure11d.png}}\quad
					\subfloat[DLSR]{\includegraphics[height=.3\textheight]{figure11e.png}}\quad
				\end{figure}
			\end{column}				
		\end{columns}
	\end{frame}
	...
	\begin{frame}{Conclusions}
		\begin{footnotesize}
			\begin{alertblock}{Conclusion 1:}
				Full wavefields contain rich damage-related information
			\end{alertblock}
			\begin{alertblock}{Conclusion 2:}
				Full wavefields can be utilised to train deep learning models to perform damage identification in an end-to-end approach
			\end{alertblock}
			\begin{alertblock}{Conclusion 3:}
				Deep learning models trained on synthetic dataset generalise well and can be applied directly to experimental wavefields
			\end{alertblock}
			\begin{alertblock}{Conclusion 4:}
				Animation-based deep learning models perform better than image-based models but are more complex and require longer time for training
			\end{alertblock}
			\begin{alertblock}{Conclusion 5:}
				Deep learning approaches surpass the conventional signal processing techniques
			\end{alertblock}
			\begin{alertblock}{Conclusion 6}
				The DLSR model can speed up the process of data acquisition by SLDV (from LR measurements to HR measurements).
			\end{alertblock}
		\end{footnotesize}		
	\end{frame}		
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
