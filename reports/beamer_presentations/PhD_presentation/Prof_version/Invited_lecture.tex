...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	\begin{columns}[T]
			\only<1>{
				...
				\column{0.9\textwidth}
				\begin{figure}
					\includegraphics[width=0.9\textwidth]{/figs2/Lamb_wave_modes_selectivity_cp.png}
				\end{figure}
			}
			%\only<2>{
			%	\column{0.1\textwidth}
...
Wavenumbers and signal's envelope
	\begin{figure}
		\subfloat{\animategraphics[autoplay,loop,width=.9\textwidth]{6}{figures/figs2/Hilbert/Hilbert_75_kHz_frame_}{80}{300}}
	\end{figure}	
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\setcounter{subfigure}{0}
	\begin{figure}
		\subfloat[Thickness map]{\includegraphics[width=.4\textwidth]{figures/figs2/Hilbert/L3_S4_B_Thickness_map_Data75_packet_interp.png}}
		\quad
		\subfloat[Average amplitude of envelope]{\includegraphics[width=.4\textwidth]{figures/figs2/Hilbert/L3_S4_B_Mean_amplitude_selected_Data75_packet_interp.png}}
	\end{figure}	
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Conclusions}
