...
\begin{frame}{Conventional approaches}
	...
	\end{itemize}
	\begin{figure}
		\subfloat{\includegraphics[width=0.8\textwidth]{conventional_ML.png}}
	\end{figure}	
...
\begin{frame}{Numerical test cases animation of Lamb waves}
	\begin{columns}[T]
		\begin{column}[c]{0.32\textwidth}
			\begin{figure}
				\animategraphics[autoplay,loop,height=.35\textheight]{6}{figures/gif_figs/397_convLSTM/397_convLSTM-}{0}{23}
				\caption{\(1^{st}\) case.}
			\end{figure}
		\end{column}
		\begin{column}[c]{0.32\textwidth}
			\begin{figure}
				\animategraphics[autoplay,loop,height=.35\textheight]{6}{figures/gif_figs/438_convLSTM/438_convLSTM-}{0}{23}
				\caption{\(2^{nd}\) case.}
			\end{figure}
		\end{column}
		\begin{column}[c]{0.32\textwidth}
			\begin{figure}
				\animategraphics[autoplay,loop,height=.35\textheight]{6}{figures/gif_figs/456_convLSTM/456_convLSTM-}{0}{23}
				\caption{\(3^{rd}\) case.}
			\end{figure}
		\end{column}
	\end{columns}
	\begin{columns}[T]
		\begin{column}[c]{0.32\textwidth}
			\begin{figure}
				\includegraphics[height=.35\textheight]{figures/predicted_397.png}
				\caption{Prediction}
			\end{figure}
		\end{column}
		\begin{column}[c]{0.32\textwidth}
			\begin{figure}
				\includegraphics[height=.35\textheight]{figures/predicted_438.png}
				\caption{Prediction}
			\end{figure}
		\end{column}
		\begin{column}[c]{0.32\textwidth}
			\begin{figure}
				\includegraphics[height=.35\textheight]{figures/predicted_456.png}
				\caption{Prediction}
			\end{figure}
		\end{column}
	\end{columns}
...
\begin{frame}{Experimental results full wavefield based}
		\centering
		\begin{figure}
			\animategraphics[autoplay,loop,width=.245\textwidth]{12}{figures/gif_figs/exp/exp-}{0}{447}
			\qquad
