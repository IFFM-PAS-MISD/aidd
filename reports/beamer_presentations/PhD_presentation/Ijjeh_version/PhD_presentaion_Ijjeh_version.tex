...
%	\end{frame}
	...
	\begin{frame}{Convolution operation (Feature extractor)}
		\begin{figure}[t]
			\centering
			\subfloat[Full wavefield]{\animategraphics[autoplay,loop,height =0.90\textheight]{2}{figures/gif_figs/files/plot_convolution_process_}{0}{32}}\quad
		\end{figure}
	\end{frame}
			...
			\begin{columns}[T]
				...
				\begin{column}[c]{0.8\textwidth}
					\begin{figure}[ht!]
						...
						\subfloat[SR]{\includegraphics[height=.22\textheight]{figure10e.png}}\quad
						...
						\subfloat[Pred]{\includegraphics[height=.22\textheight]{figure11e.png}}\quad
					\end{figure}
				\end{column}				
			\end{columns}
		\end{frame}
