...
\begin{frame}{Structural Health Monitoring (SHM)}
	\subfloat{\includegraphics[width=.95\textwidth]{SHM_system.png}}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}{Non Destructive Evaluations (NDEs)}
	...
	\hfill
	\begin{minipage}[c]{0.3\textwidth}
		\subfloat{\includegraphics[width=.97\textwidth]{local_ultrasonic.png}}
	\end{minipage}	
	\hfill
...
\begin{frame}{What are Composite Laminates?}
	...
	\end{minipage}
	\hfill
	\begin{minipage}[c]{.65\textwidth}		\subfloat{\includegraphics[width=.9\textwidth]{compsite_laminates.png}}	
	\end{minipage}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
