...
\begin{frame}{Non Destructive Evaluations (NDEs)}
	...
	\textbf{Visual inspections, eddy current, dye penetration, acrostic emission,\colorbox{yellow}{\textcolor{blue}{ultrasonic testing}} \colorbox{yellow}{\textcolor{blue}{(local NDEs)}} \& \textcolor{blue}{guided wave testing (global NDEs)}}.
...
\begin{frame}{Conventional approaches}
	...
	\begin{itemize}
		\item \alert<2>{Requires a great amount of human labor and computational effort.}
		\item \alert<3>{Demands a high amount of experience of the practitioner.}
		\item \alert<4>{Inefficient with big data which requires a complex computation of damage features.} 
		\end{itemize}
\end{frame}
