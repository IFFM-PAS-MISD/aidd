...
\begin{document}
	...
	\begin{frame}{Structural Health Monitoring (SHM)}
		\begin{figure}
			\includegraphics[width=.9\textwidth]{SHM_system.png}
		\end{figure}
	\end{frame}
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\begin{frame}{Dataset description}
		\begin{columns}[T]
			...
			\begin{column}[c]{0.3\textwidth}
				\begin{figure}
					\centering
					\includegraphics[width=0.75\textwidth]{figure_overlap.png}
					\caption{all cases overlapped}
				\end{figure}
			\end{column}
		\end{columns}	
	\end{frame}
	...
	\begin{frame}{Image semantic segmentation}
		\begin{columns}[T]
			...
			\begin{column}[t]{0.32\textwidth}
				\begin{figure}
					\includegraphics[height=.3\textheight]{RMS_flat_shell_Vz_381_500x500bottom.png}
					\caption{Single input}			
				\end{figure}
				\begin{figure}
					\animategraphics[autoplay,loop,height=.3\textheight]{4}{figures/gif_figs/381_output/flat_shell_Vz_381_500x500bottom-}{85}{113}
					\caption{Full wavefield frames}
				\end{figure}
			\end{column}
			\begin{column}[t]{0.32\textwidth}
				\begin{figure}
					\includegraphics[height=.3\textheight]{GCN_381.png}			\caption{Single output}
				\end{figure}
				\begin{figure}
					\includegraphics[height=.3\textheight]{GCN_381.png}
	...
	%	\begin{column}[c]{0.35\textwidth}
			...
			\begin{columns}[T]		
				...
				\begin{column}[t]{0.65\textwidth}
					\begin{figure}
						...
						\caption{Damage map and thresholded damage map (RMS)}
					\end{figure}
				\end{column}
			\end{columns}
			IoU= $0.23$ and $\epsilon=10.16\%$  for the RMS damage map.
		\end{frame}
		...
		\begin{frame}{Super-resolution image reconstruction}
			...
			\tiny
			\begin{itemize}
				\item Ijjeh, Abdalraheem, Saeed Ullah, Maciej Radzienski, and Pawel Kudela. "Deep learning super-resolution for the reconstruction of full wavefield of Lamb waves." Mechanical Systems and Signal Processing 186 (2023): 109878.
			\end{itemize}
		\end{frame}
		...
		\begin{frame}{Experimental test case at certain frame}
			...
			\begin{columns}[T]
				\begin{column}[c]{0.32\textwidth}
					\begin{figure}
						\centering
						\includegraphics[height=.25\textheight]{figure10a.png}
						\caption{HR ref}
					\end{figure}
					\begin{figure}
						\centering
						\includegraphics[height=.25\textheight]{figure11a.png}
						\caption{Ref}
					\end{figure}
				\end{column}
				\begin{column}[c]{0.32\textwidth}
					\begin{figure}
						\centering
						\includegraphics[height=.25\textheight]{figure10b.png}
						\caption{Compressive Sensing}
					\end{figure}
					\begin{figure}
						\centering
						\includegraphics[height=.25\textheight]{figure11b.png}
						\caption{Compressive Sensing}
					\end{figure}
				\end{column}
				\begin{column}[c]{0.32\textwidth}
					\begin{figure}
						\centering
						\includegraphics[height=.25\textheight]{figure10e.png}
						\caption{SR $f_n$}
					\end{figure}
					\begin{figure}
						\centering
						\includegraphics[height=.25\textheight]{figure11e.png}
						\caption{Pred}
					\end{figure}
				\end{column}
			\end{columns}
