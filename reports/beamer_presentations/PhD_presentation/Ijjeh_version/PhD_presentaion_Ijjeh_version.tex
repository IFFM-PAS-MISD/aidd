...
\begin{document}
	...
	\note{
		...
		\\
		For the local ultrasonic testing, the ultrasonic waves are in range of (2 MHz- 200 MHz) and their wavelength is way smaller than the thickness of structure.
		...
		Or, the propagation of guided Lamb waves can be registered using scanning laser Doppler vibrometer to produce a full wavefield scan.
...
%						\only<1>{\subfloat[All random delaminations]{\includegraphics[width=0.7\textwidth]{figure_overlap.png}}}
	...
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	\note{
		The novelty of this work consists of applying for the first time a full wavefield dataset
		of elastic wave propagation (a numerically generated dataset) as an input to various
		supervised deep neural networks, which is capable of identifying damage. Accordingly,
		two main approaches were adopted:
		1. One-to-one approach
		2. Many-to-one approach
	}
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
