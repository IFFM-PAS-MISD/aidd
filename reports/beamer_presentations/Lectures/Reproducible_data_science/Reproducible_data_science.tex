...
It is very likely that you have to hand it off to somebody else at some point because they may want to extend it, validate it, present it, learn it, etc. Thus, they have to revisit and understand what you did so far. 
...
The typical data-driven research workflow can look like in this diagram.
...
\column{0.5\textwidth}
	\centering
Use \alert{Markdown} for writing \texttt{README.md}	
\includegraphics[scale=0.04]{markdown_logo.png}
\end{columns}
\end{frame}
%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[label=frame18]{Use version control (1)}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[label=frame19]{Use version control (2)}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
Snakemake is quite popular in the field of bio-informatics.
...
These rules are written in a text file named Makefile.
...
A phony target is a pseudo-target that is not really the name of a file; rather it is just a name for a recipe to be executed. There are two reasons to use a phony target: to avoid a conflict with a file of the same name, and to improve performance.
...
\end{frame}
%%%%%%%%%%%%%%%%%%%%
\note{Other elements of Makefile are
Shebang, comment variable definitions}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[label=frame23]{Share your computing environment}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[label=frame24]{References}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
