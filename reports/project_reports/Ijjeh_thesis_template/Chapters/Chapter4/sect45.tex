...
The maximum possible distance between grid points according to Nyquist theorem is calculated as in Eqn.~(\ref{eq:dx}):
\begin{equation}
...
\begin{figure} [!h]
	\centering
	\includegraphics[scale=2]{Figures/Chapter_4/Nyquist_wavelength.png}
