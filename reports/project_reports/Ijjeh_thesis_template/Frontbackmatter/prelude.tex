...
\newcommand{\publications}
{
	...
	\begin{itemize}
		...
		techniques, chapter in: Wybrane zagadnienia inżynierii mechanicznej 2022, Praca zbiorowa pod redakcją M. Mieloszyk, T. Ochrymiuka, Wydawnictwo Instytutu Maszyn Przepływowych PAN, Gdańsk, 2022, ISBN 000-00-00000-00-0.
	\end{itemize}
	\par\medskip
