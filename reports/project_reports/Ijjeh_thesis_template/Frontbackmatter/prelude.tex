...
{	
	Structural health monitoring (SHM) and non-destructive testing (NDT) technologies are employed to predict the structural remaining functional life via proper diagnosis and prognosis methods.
	...
	Hence, the potential of utilising artificial intelligence-based approaches to investigate damage detection and identification based on the propagation of Lamb waves is explored.
	...
	In summary, this dissertation will investigate the feasibility of utilising full wavefields of Lamb wave propagation based on various deep learning-based approaches in order to identify delamination in composite laminates.
