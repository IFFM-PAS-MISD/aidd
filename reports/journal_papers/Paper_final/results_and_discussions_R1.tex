...
The IoU = \(0.73\) for sigmoid, and IoU = \(0.65\) for the softmax.
	...
	\begin{figure} [!h]
		...
		\begin{subfigure}[b]{0.47\textwidth}
			\centering
			\includegraphics[scale=1]{fig8a.png}
			\caption{RMS bottom}
		...
		\hfill
			\begin{subfigure}[b]{0.47\textwidth}
			\centering
			\includegraphics[scale=1]{fig8b.png}
		...
		\begin{subfigure}[b]{0.47\textwidth}
			\centering
			\includegraphics[scale=1]{fig8c.png}
		...
		\begin{subfigure}[b]{0.47\textwidth}
			\centering
			\includegraphics[scale=1]{fig8d.png}
		...
		\begin{subfigure}[b]{0.47\textwidth}
			\centering
		\includegraphics[scale=1]{fig8e.png}
		...
		\begin{subfigure}[b]{0.47\textwidth}
			\centering
			\includegraphics[scale=1]{fig8f.png}
			\caption{softmax}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	\begin{figure} [!h]
		...
		\begin{subfigure}[b]{0.47\textwidth}
			\centering
			\includegraphics[scale=1]{fig9a.png}
			\caption{RMS bottom}
		...
		\begin{subfigure}[b]{0.47\textwidth}
			\centering
			\includegraphics[scale=1]{fig9b.png}
			\caption{Ground truth}
		...
		\begin{subfigure}[b]{0.47\textwidth}
			\centering
			\includegraphics[scale=1]{fig9c.png}
			\caption{Adaptive wavenumber filtering (ERMSF)}
		...
		\begin{subfigure}[b]{0.47\textwidth}
			\centering
			\includegraphics[scale=1]{fig9d.png}
			\caption{Binary ERMSF}
		...
		\begin{subfigure}[b]{0.47\textwidth}
			\centering
			\includegraphics[scale=1]{fig9e.png}
			\caption{sigmoid (tr =\(0.5\))}
		...
		\begin{subfigure}[b]{0.47\textwidth}
			\centering
			\includegraphics[scale=1]{fig9f.png}
			\caption{softmax}
...
\begin{figure}[!h]
	...
	\begin{subfigure}[b]{0.47\textwidth}
		\centering
		\includegraphics[scale=1]{fig10a.png}
		\caption{RMS bottom}
	...
	\begin{subfigure}[b]{0.47\textwidth}
		\centering
		\includegraphics[scale=1]{fig10b.png}
		\caption{ground truth}
	...
	\begin{subfigure}[b]{0.47\textwidth}
		\centering
		\includegraphics[scale=1]{fig10c.png}
		\caption{Adaptive wavenumber filtering (ERMSF)}
	...
	\begin{subfigure}[b]{0.47\textwidth}
		\centering
		\includegraphics[scale=1]{fig10d.png}
		\caption{binary ERMSF}
...
\begin{figure}[!h]
	...
	\begin{subfigure}[b]{0.47\textwidth}
		\centering
		\includegraphics[scale=1]{fig11a.png}
		\caption{ground truth}
		\label{fig:GT_385}
	\end{subfigure}
	\hfill
	\begin{subfigure}[b]{0.47\textwidth}
		\centering
		\includegraphics[scale=1]{fig11b.png}
...
The problem with delaminations at the corners for the FCN model can be alleviated by enhancing feature extraction process by obtaining more data to train the model to recognise and learn new patterns.
...
However, the generation of large dataset comprised of experiments with various defects is troublesome.
	\begin{figure} [!h]
		...
		\begin{subfigure}[b]{0.47\textwidth}
			\centering
			\includegraphics[scale=1]{fig12a.png}
		...
		\begin{subfigure}[b]{0.47\textwidth}
			\centering 	
			\includegraphics[scale=1]{fig12b.png}
			\caption{Ground truth} 
		...
		\begin{subfigure}[b]{0.47\textwidth}
			\centering
			\includegraphics[scale=1]{fig12c.png}
			\caption{ERMSF} 
		...
		\begin{subfigure}[b]{0.47\textwidth}
		\centering
		\includegraphics[scale=1]{fig12d.png}
		\caption{Binary ERMSF} 
		...
		\begin{subfigure}[b]{0.47\textwidth}
			\centering
			\includegraphics[scale=1]{fig12e.png}
		...
		\begin{subfigure}[b]{0.47\textwidth}
			\centering
			\includegraphics[scale=1]{fig12f.png}
