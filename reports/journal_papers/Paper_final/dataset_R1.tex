...
\begin{figure} [h!]
	...
	\begin{subfigure}[b]{0.32\textwidth}
		\centering
		\includegraphics[scale=1]{fig3a.png}
		\caption{\(t=0.141\) ms}
	...
	\begin{subfigure}[b]{0.32\textwidth}
		\centering
		\includegraphics[scale=1]{fig3b.png}
		\caption{\(t=0.188\) ms}
	...
	\begin{subfigure}[b]{0.32\textwidth}
		\centering
		\includegraphics[scale=1]{fig3c.png}
		\caption{\(t=0.240\) ms}
	...
	\begin{subfigure}[b]{0.32\textwidth}
		\centering
		\includegraphics[scale=1]{fig3d.png}
		\caption{\(t=0.141\) ms}
	...
	\begin{subfigure}[b]{0.32\textwidth}
		\centering
		\includegraphics[scale=1]{fig3e.png}
		\caption{\(t=0.188\) ms}
	...
	\begin{subfigure}[b]{0.32\textwidth}
		\centering
		\includegraphics[scale=1]{fig3f.png}
		\caption{\(t=0.240\) ms}
...
\begin{figure} [h!]
	...
	\begin{subfigure}[b]{0.47\textwidth}
		\centering
		\includegraphics[scale=1]{fig4a.png}
		\caption{top}
		\label{fig:rmstop}
	\end{subfigure}
	\hfill
	\begin{subfigure}[b]{0.47\textwidth}
		\centering
		\includegraphics[scale=1]{fig4b.png}
		\caption{bottom}
		\label{fig:rmsbottom}
	\end{subfigure}
