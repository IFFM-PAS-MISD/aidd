...
%Moreover, conventional damage detection methods based on guided waves are application specific which implies that the extracted features from the structure depends on the damage type (i.e. crack, delamination, etc.) du it is not certain that such hand crafted features are reusable for
