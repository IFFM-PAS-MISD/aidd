...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
The main purpose of utilising deep learning methods is to perform the feature extraction process automatically through feeding the models the full wavefield images.
