...
Additionally, it is also important to select a proper accuracy metric of the model, therefore, we have applied intersection over union (IoU) also known as \emph{Jaccard Index} as our accuracy metric. 
