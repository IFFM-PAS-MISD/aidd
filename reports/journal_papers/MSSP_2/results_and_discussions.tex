...
%	\end{figure} 
	...
	\begin{figure} [!h]
		...
		\begin{subfigure}[b]{0.47\textwidth}
			\centering
			\includegraphics[scale=1.0]{unet_pred_sigmoid_391.png}
		...
		\begin{subfigure}[b]{0.47\textwidth}
			\centering
			\includegraphics[scale=1.0]{vgg16_pred_sigmoid_391.png}
		...
		\begin{subfigure}[b]{0.47\textwidth}
			\centering
			\includegraphics[scale=1.0]{pspnet_pred_sigmoid_391.png}
		...
		\begin{subfigure}[b]{0.47\textwidth}
			\centering
			\includegraphics[scale=1.0]{fcn_densenet_pred_sigmoid_391.png}
	...
	\begin{figure}[!h]
		...
		\begin{subfigure}[b]{0.47\textwidth}
			\centering
			\includegraphics[scale=1.0]{Unet_Pred__softmax391.png}
		...
		\begin{subfigure}[b]{0.47\textwidth}
			\centering
			\includegraphics[scale=1.0]{vgg16_pred__softmax391.png}
			\caption{VGG16 encoder-decoder softmax}			\label{fig:vgg16_pred__softmax391}			
		\end{subfigure}
		\hfill
		\begin{subfigure}[b]{0.47\textwidth}
			\centering
			\includegraphics[scale=1.0]{pspnet_pred__softmax391.png}
		...
		\begin{subfigure}[b]{0.47\textwidth}
			\centering
			\includegraphics[scale=1.0]{fcn_densenet_pred__softmax391.png}
...
\begin{figure}[!h]
	...
	\begin{subfigure}[b]{0.47\textwidth}
		\centering
		\includegraphics[scale=1.0]{RMS_bottom_442.png}
		\caption{RMS bottom}
	...
	\begin{subfigure}[b]{0.47\textwidth}
		\centering
		\includegraphics[scale=1.0]{ground_truth_442.png}
		\caption{Ground truth}
		\label{fig:m1_rand_single_delam_442}
	\end{subfigure}
	\begin{subfigure}[b]{0.47\textwidth}
		\centering
		\includegraphics[scale=1.0]{Unet_Pred__softmax442.png}
		\caption{UNet softmax}
	...
	\begin{subfigure}[b]{0.47\textwidth}
		\centering
		\includegraphics[scale=1.0]{vgg16_pred__softmax442.png}
		\caption{VGG16 encoder-decoder softmax}			\label{fig:vgg16_pred__softmax442}			
	\end{subfigure}
	\hfill
	\begin{subfigure}[b]{0.47\textwidth}
		\centering
		\includegraphics[scale=1.0]{pspnet_pred__softmax442.png}
		\caption{PSPNet softmax}
	...
	\begin{subfigure}[b]{0.47\textwidth}
		\centering
		\includegraphics[scale=1.0]{fcn_densenet_pred__softmax442.png}
		\caption{FCN-DenseNet softmax}
...
\begin{figure} [!h]
	...
	\begin{subfigure}[b]{0.47\textwidth}
		\centering
		\includegraphics[scale=1]{UNet_exp_softmax7.png}
		\caption{UNet} 
	...
	\begin{subfigure}[b]{0.47\textwidth}
	\centering
	\includegraphics[scale=1]{vgg16_exp_7_.png}
	...
	\begin{subfigure}[b]{0.47\textwidth}
		\centering
		\includegraphics[scale=1]{PSPnet_exp_softmax7.png}
		\caption{PSPNet} 
	...
	\begin{subfigure}[b]{0.47\textwidth}
		\centering
		\includegraphics[scale=1]{FCN_Densenet_exp_softmax7.png}
