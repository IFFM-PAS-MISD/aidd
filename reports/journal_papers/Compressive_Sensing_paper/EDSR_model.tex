...
It should be noted that Model-II is much simpler than Model-I (the total number of parameters in Model-II is 1 million). 
Therefore, Model-II can be trained faster than Model-I on a GPU with less memory.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{figure} [ht!]
	\begin{center}
