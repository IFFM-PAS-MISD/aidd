...
Figure~\ref{fig:frame110_comparison} shows the recovery of the reference frame with size of (\(512\times512\)) pixels presented in Fig.~\ref{fig:frame110_CS1024} at $N_f=110$ with the CS method and DLSR models.
