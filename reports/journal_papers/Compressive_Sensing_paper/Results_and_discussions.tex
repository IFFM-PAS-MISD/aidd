...
\begin{figure} [!ht]
	\centering
	\includegraphics[scale=.7]{figure8.png}
...
A hann-window-modulated 50 kHz five-cycle sinusoidal signals were generated by arbitrary waveform generator and amplified by linear signal amplifier connected to PZT. 
Out-of plane velocities were measured in 389286 randomly distributed points (defined arbitrarily with clustering avoidance) covering the whole back surface of the specimen using SLDV. 
Diagram of the measuring system is shown in Fig~\ref{fig:exp_setup}. 
...
\begin{figure} [!h]
	...
	\caption{Experimental set-up diagram.}
	\label{fig:exp_setup}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
