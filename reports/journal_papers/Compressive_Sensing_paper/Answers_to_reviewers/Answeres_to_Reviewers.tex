	...
	\begin{enumerate}
		...
		\textcolor{Cyan}
		{
			...
			\emph{
				...
				Out-of plane velocities were measured in 389286 randomly distributed points (defined arbitrarily with clustering avoidance) covering the whole back surface of the specimen using SLDV. Diagram of the measuring system is shown in Fig 13. 
