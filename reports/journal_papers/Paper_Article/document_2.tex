...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	Furthermore data augmentation were achieved by flipping images horizontally, vertically and diagonally, by performing that we increased the dataset size four times, (\(1900\)) images were produced.
	
	Such data augmentation can enhance the learning process by produce new different patterns which can enhance the model performance to generalize and improve the model accuracy of damage detection
