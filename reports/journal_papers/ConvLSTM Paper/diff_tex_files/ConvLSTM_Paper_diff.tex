...
%DIF DEL /home/aijjeh/Desktop/PhD_work/Publications/MSSP_3_article/MSSP_3_complete_version/MSSP_3_to_review_23_11_2021/ConvLSTM Paper_submitted_15_12_2021/ConvLSTM_Paper.tex   Thu Sep  2 09:40:16 2021
%DIF ADD /home/aijjeh/Documents/GitHub/aidd_new/reports/journal_papers/ConvLSTM Paper/ConvLSTM_Paper.tex                                                                        Wed Feb 16 12:39:20 2022
%% 
...
%DIF 77c77-78
%DIF < \graphicspath{{Graphics/}{//Graphics/}}
%DIF -------
\graphicspath{{Graphics/}{//Graphics/}}
%{//pkudela_odroid_sensors/aidd/reports/journal_papers/MSSP_3/ConvLSTM_Paper/figs/}{//aijjeh_odroid_sensors/aidd/reports/journal_papers/MSSP_3/ConvLSTM_Paper/figs/}} %DIF > 
 %DIF > 
%DIF -------
...
\end{keyword}
	\end{frontmatter}
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	\input{Introduction_diff}
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	\input{Methodology_diff}
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	\input{RNNS_LSTM_and_ConvLSTM_diff}
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	\input{Proposed_approach_diff}
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	\input{Results_and_discussions_diff}
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	\clearpage
	\input{Conclusions_diff}
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
