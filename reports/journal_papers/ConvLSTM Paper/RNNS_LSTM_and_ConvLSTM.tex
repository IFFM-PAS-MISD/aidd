...
Hence, the ConvLSTM unit, which is a combination of CNN and LSTM units, was introduced by Shi et al.~\cite{xingjian2015convolutional} to solve such a problem.
