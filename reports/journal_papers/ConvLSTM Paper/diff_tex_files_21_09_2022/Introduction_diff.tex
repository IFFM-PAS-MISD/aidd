...
\begin{sloppypar}
	...
	resistance~\DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\cite{giurgiutiu2015structural, stoik2010nondestructive, poudel2015comparison}}\hskip0pt%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\cite{giurgiutiu2015structural, stoik2010nondestructive}}\hskip0pt%DIFAUXCMD
}\DIFaddend .
	However, these materials are prone to various kinds of defects such as 
	cracks, fiber breakage, debonding, and 
	delamination~\DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\cite{poudel2015comparison, talreja2012damage}}\hskip0pt%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\cite{talreja2012damage}}\hskip0pt%DIFAUXCMD
}\DIFaddend .
	...
	transducers~\DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\cite{Barthorpe2020, Ihn2008, Cantero-Chinchilla2020}}\hskip0pt%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\cite{Barthorpe2020, Ihn2008}}\hskip0pt%DIFAUXCMD
}\DIFaddend . 
	...
	pashaei2020review}.
	\DIFdelbegin \DIFdel{In recent years, }\DIFdelend \DIFaddbegin \DIFadd{There are many factors that led to this significant rise of deep learning 
	...
	costs~\mbox{%DIFAUXCMD
\cite{pu2021automatic, wang2020big}}\hskip0pt%DIFAUXCMD
.
	Recently, }\DIFaddend deep learning has shown significant improvements in image 
	...
	and maintenance of civil infrastructures~\DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\cite{cha2017deep, Lin2017a, Liu2019} }\hskip0pt%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\cite{cha2017deep, Lin2017a, 
	Liu2019, wang2020research} }\hskip0pt%DIFAUXCMD
}\DIFaddend and rotating 
	...
	\DIFdelbegin \DIFdel{As in }\DIFdelend \DIFaddbegin \DIFadd{Similar to }\DIFaddend our previous research work~\cite{Ijjeh2021, Ijjeh2022}, two 
