...
\begin{sloppypar}
	...
	\DIFaddbegin \DIFadd{The colour scale range from 0 to 1 corresponds to sigmoid output and can be interpreted as a probability of delamination occurrence.
	}\DIFaddend Figures~\ref{fig:Convlstm_binary_RMS_391} and~\ref{fig:AE_binary_RMS_391} show the binary RMS of damage maps with respect to Model-I, and Model-II, respectively.
	...
	\begin{figure} [!ht]
		...
		\begin{subfigure}[b]{0.48\textwidth}
			...
			\caption{\DIFdelbeginFL \DIFdelFL{Model~I}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Model-I}\DIFaddendFL }
	...
	\begin{figure}[ht!]
		...
		\begin{subfigure}[b]{0.32\textwidth}
			...
			\caption{\DIFdelbeginFL \DIFdelFL{Model~I}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Model-I}\DIFaddendFL , IoU\(=0.64\)}
		...
		\begin{subfigure}[b]{0.32\textwidth}
			...
			\caption{\DIFdelbeginFL \DIFdelFL{Model~I}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Model-I}\DIFaddendFL , IoU\(=0.63\)}
		...
		\begin{subfigure}[b]{0.32\textwidth}
			...
			\caption{\DIFdelbeginFL \DIFdelFL{Model~I}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Model-I}\DIFaddendFL , IoU\(=0.85\)}
		...
		\end{subfigure}
		\caption{Binary RMS predictions regarding Model-I and Model-II\DIFaddbeginFL \DIFaddFL{.}\DIFaddendFL }
...
%	It can be concluded that the models that take animations as an input surpass the models that take only the RMS images as input. 
	...
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	\begin{table}[ht!]
		\caption{Evaluation metrics of the three numerical cases\DIFaddbeginFL \DIFaddFL{.}\DIFaddendFL }
	...
	\begin{table}[ht!]
		\centering
		\caption{Mean intersection over union $\overline{\textup{IoU}}$ for numerical cases with respect to the input of the model\DIFaddbeginFL \DIFaddFL{.}\DIFaddendFL }
		\begin{tabular}{llc}
			\toprule
	...
	\DIFdelbegin \DIFdel{\(500\times 500\)~mm}\DIFdelend \DIFaddbegin \DIFadd{\((500\times500)\)~mm\(^{2}\)}\DIFaddend . 
...
%	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	%DIF < 	The intermediate predicted outputs of Model-I and Model-II for windows centered at frame 84 (the dark blue star), frame 141 (pink pentagon), and frame 218 (the green circle) are shown in Fig.~\ref{fig:CFRP_Teflon_3o_predictions}.
	\DIFaddbegin \DIFadd{The intermediate predicted outputs of Model-I and Model-II for windows centered at frame 84 (the dark blue star), frame 141 (pink pentagon), and frame 218 (the green circle) are shown in Fig.~\ref{fig:CFRP_teflon_3o_intermediate}.
	}\DIFaddend Apart from correctly identified delamination, some noise is obtained near edges of the specimen.
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\begin{figure} [!ht]
		...
		%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
		%DIF > %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
		\DIFaddbeginFL \par\medskip
		%DIF > %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
		\begin{subfigure}[b]{1\textwidth}
			\centering
			\includegraphics[scale=.9]{CFRP_teflon_3o_Centre_predictions.png}
			\DIFaddendFL \caption{\DIFdelbeginFL \DIFdelFL{IoU for the sliding window }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Predictions }\DIFaddendFL of \DIFdelbeginFL \DIFdelFL{frames (Teflon insert-single delamination)}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{models I and II at different window places}\DIFaddendFL .} 
			\DIFaddbeginFL \label{fig:CFRP_teflon_3o_intermediate}
		\end{subfigure}
		%DIF > %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
		\caption{\DIFaddFL{IoU for the sliding window of frames (Teflon insert-single delamination), and the intermediate predictions.}}
		\DIFaddendFL \label{fig:CFRP_Teflon_3o_IoU_centre_window}
	\end{figure} 
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\begin{table}[ht]
		...
		\caption{Evaluation metrics for experimental case of single delamination\DIFaddbeginFL \DIFaddFL{.}\DIFaddendFL }
		\begin{tabular}{cccccccc}
			\toprule
