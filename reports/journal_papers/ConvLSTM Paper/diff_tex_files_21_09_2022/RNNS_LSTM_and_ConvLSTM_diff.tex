...
\begin{sloppypar}
	...
	markets, \DIFaddbegin \DIFadd{email traffic prediction, }\DIFaddend text data analysis, and many 
	more~\DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\cite{graves2014towards, cho2014properties}}\hskip0pt%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\cite{graves2014towards, cho2014properties, om2020modelling}}\hskip0pt%DIFAUXCMD
}\DIFaddend . 
	...
	in \DIFdelbegin \DIFdel{more and }\DIFdelend \DIFaddbegin \DIFadd{various domains for capturing spatio-temporal features such as traffic 
	flow prediction in intelligent transportation system~\mbox{%DIFAUXCMD
\cite{yu2017spatio}}\hskip0pt%DIFAUXCMD
, 
	surveillance-based systems~\mbox{%DIFAUXCMD
\cite{mugunga2021frame}}\hskip0pt%DIFAUXCMD
, remaining useful life 
	prediction of rolling bearings~\mbox{%DIFAUXCMD
\cite{li2021self}}\hskip0pt%DIFAUXCMD
, crop yield 
	forecasting~\mbox{%DIFAUXCMD
\cite{gavahi2021deepyield}}\hskip0pt%DIFAUXCMD
, action recognition and anomaly 
	detection in videos~\mbox{%DIFAUXCMD
\cite{medel2016anomaly, xue2019attention}}\hskip0pt%DIFAUXCMD
, and many 
	}\DIFaddend more image processing \DIFaddbegin \DIFadd{and computer vision-related }\DIFaddend applications.
\end{sloppypar}
