...
Furthermore, the mean percentage size error was calculated for all numerical cases (\(95\)) for models~\RNum{1} and~\RNum{2} equal to \(4.57 \%\) and \(8.42\%\), respectively.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{table}[]
	\begin{tabular}{c|c|ccc|ccc}
		...
		1 & 272 & \multicolumn{1}{c|}{0.86} & \multicolumn{1}{c|}{}           &          & \multicolumn{1}{c|}{0.87} & \multicolumn{1}{c|}{281}           & 3.3\%      \\ \hline
		2    &  186  & \multicolumn{1}{c|}{0.89} & \multicolumn{1}{c|}{}           &            & \multicolumn{1}{c|}{0.93} & \multicolumn{1}{c|}{178} & 4.3\% \\ \hline
		3    & 842 & \multicolumn{1}{c|}{0.98} & \multicolumn{1}{c|}{}           &            & \multicolumn{1}{c|}{0.99} & \multicolumn{1}{c|}{871}  & 3.4\% \\ \hline
	\end{tabular}
\end{table}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Numerical cases
