...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	\begin{subfigure}[b]{0.32\textwidth}
		\centering
		\includegraphics[width=1\textwidth]{numerical_GT_391.png}
	...
	\begin{subfigure}[b]{0.32\textwidth}
		\centering
		\includegraphics[width=1\textwidth]{model_1_predicted_output_391.png} 
	...
	\begin{subfigure}[b]{0.32\textwidth}
		\centering
		\includegraphics[width=1\textwidth]{model_2_predicted_391.png}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	\begin{subfigure}[b]{0.32\textwidth}
		\centering
		\includegraphics[width=1\textwidth]{numerical_GT_462.png}
	...
	\begin{subfigure}[b]{0.32\textwidth}
		\centering
		\includegraphics[width=1\textwidth]{model_1_predicted_output_462.png}
	...
	\begin{subfigure}[b]{0.32\textwidth}
		\centering
		\includegraphics[width=1\textwidth]{model_2_predicted_462.png}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	\begin{subfigure}[b]{0.32\textwidth}
		\centering
		\includegraphics[width=1\textwidth]{numerical_GT_453.png}
	...
	\begin{subfigure}[b]{0.32\textwidth}
		\centering
		\includegraphics[width=1\textwidth]{model_1_predicted_output_453.png}
	...
	\begin{subfigure}[b]{0.32\textwidth}
		\centering
		\includegraphics[width=1\textwidth]{model_2_predicted_453.png}
		\caption{\(IoU\) value = 0.99}
		\label{fig:AE_num_453}
	\end{subfigure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	\caption{Delamination cases on numerical data (Figures: (a), (e), and (h) correspond to model-\RNum{1}. 
...
\begin{figure} [!h]
	...
	\begin{subfigure}[b]{0.32\textwidth}
		\centering
		\includegraphics[width=1\textwidth]{CFRP_teflon_3o_375_375p_50kHz_5HC_x12_15Vpp_Ground_truth_0.png}
	...
	\begin{subfigure}[b]{0.32\textwidth}
		\centering
		\includegraphics[width=1\textwidth]{Saeed_CFRP_teflon_3o_375_375p_50kHz_5HC_x12_15Vpp_predicted_output_35.png}
		\caption{\(IoU\) = 0.53 } 
	...
	\begin{subfigure}[b]{0.32\textwidth}
		\centering
		\includegraphics[width=1\textwidth]{CFRP_teflon_3o_375_375p_50kHz_5HC_x12_15Vpp_predicted_output_72.png}
		\caption{\(IoU\) = 0.47}
...
\begin{figure} [!h]
	...
	\begin{subfigure}[b]{1\textwidth}
		\centering
		\includegraphics[scale=1]{CFRP_Teflon_3o_IoU_centre_window.png}
		\caption{}
	...
	\begin{subfigure}[b]{1\textwidth}
		\centering
		\includegraphics[scale=1]{CFRP_teflon_3o_shapes_blue_pink_circle.png}
		\caption{} 
...
\begin{figure}[!h]
	\centering
	\includegraphics[scale=1]{CFRP_teflon_3o_Centre_predictions.png}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Additionally, for the experimental cases, we applied the root mean square (RMS) for all output predictions regarding all slided windows in order to show the damage map.
...
\begin{figure} [!h]
	...
	\begin{subfigure}[b]{.48\textwidth}
		\centering
		\includegraphics[width=1\textwidth]{RMS_CFRP_Teflon_3o_5HC_Saeed.png}
	...
	\begin{subfigure}[b]{.48\textwidth}
		\centering
		\includegraphics[width=1\textwidth]{RMS_CFRP_Teflon_3o_5HC_ijjeh.png}
...
\begin{figure} [!h]
	...
	\begin{subfigure}[b]{.48\textwidth}
		\centering
		\includegraphics[scale=1]{RMS_CFRP_teflon_3o_375_375p_50kHz_5HC_saeed_cmap_viridis_greyscale_THRESHOLDED.png}
	...
	\begin{subfigure}[b]{.48\textwidth}
		\centering
		\includegraphics[scale=1]{RMS_CFRP_teflon_3o_375_375p_50kHz_5HC_ijjeh_cmap_viridis_greyscale_THRESHOLDED.png}
...
\begin{figure}[!h]
	\centering
	\includegraphics[width=1\textwidth]{plate_delam_arrangement_exp_MSSP2.png}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	\begin{subfigure}[b]{0.32\textwidth}
		\centering
		\includegraphics[width=1\textwidth]{L3_S4_B_333x333p_50kHz_5HC_18Vpp_x10_pzt_Ground_truth_0.png}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	\begin{subfigure}[b]{0.32\textwidth}
		\centering
		\includegraphics[width=1\textwidth]{L3_S2_B_333x333p_50kHz_5HC_15Vpp_x10_pzt_predicted_output_167.png}
		\caption{\(IoU\) = \(0.15\)} 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	\begin{subfigure}[b]{0.32\textwidth}
		\centering
		\includegraphics[width=1\textwidth]{L3_S2_B_333x333p_50kHz_5HC_15Vpp_x10_pzt_predicted_output_68.png}
		\caption{\(IoU\) = \(0.35\)} 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\begin{subfigure}[b]{0.32\textwidth}
		\centering
		\includegraphics[width=1\textwidth]{L3_S3_B_333x333p_50kHz_5HC_18Vpp_x10_pzt_predicted_output_279.png}
		\caption{\(IoU\) = \(0.18\)} 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\begin{subfigure}[b]{0.32\textwidth}
		\centering
		\includegraphics[width=1\textwidth]{L3_S3_B_333x333p_50kHz_5HC_18Vpp_x10_pzt_predicted_output_60.png}
		\caption{\(IoU\) = \(0.32\)} 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\begin{subfigure}[b]{0.32\textwidth}
		\centering
		\includegraphics[width=1\textwidth]{L3_S4_B_333x333p_50kHz_5HC_18Vpp_x10_pzt_predicted_output_235.png}
		\caption{\(IoU\) = \(0.18\)}  
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\end{subfigure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\caption{Experimental cases of Specimen (\RNum{2}-\RNum{4}).}
\label{fig:exp_case}
\end{figure} 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
The light blue star depicted in Fig.~\ref{fig:L3_S4_B_333x333p_50kHz_5HC_shapes_} refers to a window of frames regarding the initial interactions of propagated guided with the delaminations and before reflecting from the edges.
...
\begin{figure} [!h]
	...
	\begin{subfigure}[b]{1\textwidth}
		\centering
		\includegraphics[scale=1]{L3_S4_B_333x333p_50kHz_5HC_IoU_centre_window.png}
		\caption{}
	...
	\begin{subfigure}[b]{1\textwidth}
		\centering
		\includegraphics[scale=1]{L3_S4_B_333x333p_50kHz_5HC_shapes_.png}
		\caption{} 
...
\begin{figure}[!h]
	\centering
	\includegraphics[scale=1]{L3_S4_B_predictions_different_windows.png}
...
\begin{figure} [!h]
	...
	\begin{subfigure}[b]{.49\textwidth}
		\centering
		\includegraphics[width=1\textwidth]{RMS_L3_S4_B_saeed.png}
		\caption{RMS image of model-\RNum{1} predicted output}
	...
	\begin{subfigure}[b]{.49\textwidth}
		\centering
		\includegraphics[width=1\textwidth]{RMS_L3_S4_B_ijjeh.png}
		\caption{RMS image of model-\RNum{2} predicted output} 
...
\begin{figure} [!h]
	...
	\begin{subfigure}[b]{.49\textwidth}
		\centering
		\includegraphics[scale=1]{RMS_L3_S4_B_333x333p_50kHz_5HC_saeed_cmap_viridis_greyscale_THRESHOLDED.png}
	...
	\begin{subfigure}[b]{.49\textwidth}
		\centering
		\includegraphics[scale=1]{RMS_L3_S4_B_333x333p_50kHz_5HC_ijjeh_cmap_viridis_greyscale_THRESHOLDED.png}
