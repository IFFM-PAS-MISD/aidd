...
Furthermore, the mean percentage size error (\(\delta\)) was calculated for all numerical cases (\(95\)) for models~\RNum{1} and~\RNum{2} equal to \(4.57 \%\) and \(8.42\%\), respectively.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
Furthermore, the percentage size error metric (\(\delta\)) for models~\RNum{1} and~\RNum{2} equal to \(41.78 \%\) and \(86.67\%\), respectively.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{table}[]
	...
	\begin{tabular}{cccccccc}
		\multirow{2}{*}{\begin{tabular}[c]{@{}c@{}}Experimental \\ case\end{tabular}} & \multirow{2}{*}{\(A\ mm^2\)} & \multicolumn{3}{c}{Model-I} & \multicolumn{3}{c}{Model-II}  \\ \cline{3-5} & \cline(lt){6-8} & \multicolumn{1}{c|}{IoU} & \multicolumn{1}{c|}{\(\hat{A}\ mm^2\)} & \(\delta\) & \multicolumn{1}{c|}{IoU}  &\multicolumn{1}{c|}{\(\hat{A}\ mm^2\)} & \(\delta\) \\ \hline
		Single delamination & 225 & \multicolumn{1}{c|}{0.46} &  \multicolumn{1}{c|}{319} & 41.78\%    & \multicolumn{1}{c|}{0.42} & \multicolumn{1}{c|}{420} & 86.67\%    \\ \hline
	\end{tabular}
...
Furthermore, the mean percentage size error (\(\delta\)) with respect to the three delaminations (Specimen~\RNum{4}) for models~\RNum{1} and~\RNum{2} equal to \(79.41\%\) and \(10.61\%\), respectively.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
