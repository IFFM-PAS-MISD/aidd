...
%\end{comment}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Table~\ref{tab:meanIoU_vs_input} presents a comparison of the mean IoU for all \(95\) numerical test cases with respect the DL models.
...
\begin{table}[ht]
	...
	\begin{tabular}{cccccccc}
	\toprule
		\multirow{2}{*}{\begin{tabular}[c]{@{}c@{}}Experimental \\ case\end{tabular}} & \multirow{2}{*}{\(A\ mm^2\)} & \multicolumn{3}{c}{Model-I} & \multicolumn{3}{c}{Model-II}  \\ 
		\cmidrule(lr){3-5} \cmidrule(lr){6-8}
		&  & \multicolumn{1}{c}{IoU} & \multicolumn{1}{c}{\(\hat{A}\ mm^2\)} & \(\epsilon\) & \multicolumn{1}{c}{IoU}  &\multicolumn{1}{c}{\(\hat{A}\ mm^2\)} & \(\epsilon\) \\ 
		\midrule
