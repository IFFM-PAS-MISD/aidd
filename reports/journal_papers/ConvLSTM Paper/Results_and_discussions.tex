...
\begin{sloppypar}
	...
	Figure~\ref{fig:RMS_threshold_L3_S4_B_saeed} shows the thresholded RMS image for Model-\RNum{1}, and the calculated IoU\(=0.20\).
	Figure~\ref{fig:RMS_threshold_L3_S4_B_ijjeh} shows the thresholded RMS image for Model-\RNum{2}, and the calculated IoU\(=0.71\).
	...
	\begin{figure} [!ht]
		...
		\begin{subfigure}[b]{.49\textwidth}
			\centering
			\hspace*{-10mm}
			\includegraphics[width=4.8cm]{figure18a.png}
			\caption{Model-\RNum{1}, IoU = \(0.20\)}
		...
		\begin{subfigure}[b]{.49\textwidth}
			\centering
			\includegraphics[width=4.8cm]{figure18b.png}
			\caption{Model-\RNum{2}, IoU = \(0.71\)} 
	...
	\begin{figure} [!ht]
		...
		\begin{subfigure}[b]{.49\textwidth}
			\centering
			\includegraphics[width=1\textwidth]{figure18b.png}
			\caption{Model-\RNum{2}, IoU=\(0.71\)} 
