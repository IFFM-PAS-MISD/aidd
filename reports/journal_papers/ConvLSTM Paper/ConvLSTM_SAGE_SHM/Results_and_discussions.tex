...
\(8.42\%\) for Model-\RNum{1} and~Model-\RNum{2}, respectively.

In summary, on average, Model-\RNum{1} has better accuracy of delamination 
identification than Model-\RNum{2} but in some particular delamination 
