...
and~\ref{fig:AE_num_391} with respect to Model-\RNum{1}, and \RNum{2}, 
respectively.
...
Table~\ref{tab:num_cases} presents the evaluation metrics for Model-\RNum{1} 
and~\RNum{2}, respectively, regarding the numerical cases shown in 
...
The predicted outputs of Model-\RNum{1} and Model-\RNum{2} for windows centered 
...
\begin{figure} [!h]
	...
	\begin{subfigure}[b]{0.5\textwidth}
		\centering
		\includegraphics[width=.3\textheight]{figure9a.png}
	...
	\begin{subfigure}[b]{0.5\textwidth}
		\centering
		\includegraphics[width=.3\textheight]{figure9b.png}
...
\begin{figure}[!h]
	\centering
	\includegraphics[width=0.45\textwidth]{figure10.png}
...
and~\ref{fig:RMS_threshold_CFRP_Teflon_3o_ijjeh} for Model-\RNum{1} and 
Model-\RNum{2}, respectively. 
...
Table~\ref{tab:single_case} presents the evaluation metrics for Model-\RNum{1} 
and~\RNum{2}, receptively, regarding the experimental case of single 
...
\begin{figure} [!h]
	...
	\begin{subfigure}[b]{0.49\textwidth}
		\centering
		\includegraphics[width=.27\textheight]{figure11a.png}
		\caption{\centering Model-\RNum{1}}
	...
	\begin{subfigure}[b]{0.49\textwidth}
		\centering
		\includegraphics[width=.27\textheight]{figure11b.png}
		\caption{\centering Model-\RNum{2}} 
...
\begin{figure} [!h]
	...
	\begin{subfigure}[b]{0.49\textwidth}
		\centering
		\includegraphics[width=.27\textheight]{figure12a.png}
		\caption{\centering Model-\RNum{1}, \(IoU\) = \(0.46\)}
	...
	\begin{subfigure}[b]{0.49\textwidth}
		\centering
		\includegraphics[width=.27\textheight]{figure12b.png}
		\caption{\centering Model-\RNum{2}, \(IoU\) = \(0.42\)} 
...
The details of Specimen~\RNum{2}, \RNum{3} and \RNum{4} are presented in 
Figure~\ref{fig:plate_delam_arrangment}.
...
\begin{figure}[!h]
	\centering
	\includegraphics[width=0.45\textwidth]{figure13.png}
...
The predicted output of Model-\RNum{1} is shown in 
...
cross-section was not modeled numerically (see Specimen~\RNum{4} in 
Figure~\ref{fig:plate_delam_arrangment}).
...
\begin{figure} [!h]
	...
	\begin{subfigure}[b]{0.32\textwidth}
		...
		\caption{\centering GT of Specimen~\RNum{2}}
	...
	\begin{subfigure}[b]{0.32\textwidth}
		\centering
		\includegraphics[width=1\textwidth]{figure14a.png}
		\caption{\centering GT of Specimen~\RNum{3}}
	...
	\begin{subfigure}[b]{0.32\textwidth}
		\centering
		\includegraphics[width=1\textwidth]{figure14a.png}
		\caption{\centering GT of Specimen~\RNum{4}}
...
Model-\RNum{1} and Model-\RNum{2} regarding Specimen~\RNum{4} as we slide the 
...
The red square depicted in Figure~\ref{fig:L3_S4_B_333x333p_50kHz_5HC_shapes_} 
...
\(IoU\) value regarding Model-\RNum{1} and corresponding frame at the centre of 
the window.
...
The green circle depicted in 
Figure~\ref{fig:L3_S4_B_333x333p_50kHz_5HC_IoU_centre_window} represents high 
\(IoU\) value regarding Model-\RNum{2} and corresponding frame at the centre of 
the window.
...
\begin{figure} [!h]
	...
	\begin{subfigure}[b]{0.5\textwidth}
		\centering
		\includegraphics[width=.3\textheight]{figure15a.png}
		\caption{\centering IoU for the sliding window centered at consecutive 
		frames.}
	...
	\begin{subfigure}[b]{0.5\textwidth}
		\centering
		\includegraphics[width=.3\textheight]{figure15b.png}
		\caption{\centering Corresponding frames of guided waves.} 
...
The RMS images depicting the damage maps of Specimen~\RNum{4} are presented in 
Figures~\ref{fig:RMS_L3_S4_B_saeed} and~\ref{fig:RMS_L3_S4_B_ijjeh} regarding 
Model-\RNum{1} and Model-\RNum{2}, respectively.
...
\begin{figure} [!h]
	...
	\begin{subfigure}[b]{0.49\textwidth}
		\centering
		\includegraphics[width=.27\textheight]{figure18a.png}
		\caption{\centering Model-\RNum{1}, \(IoU\) = \(0.07\)}
	...
	\begin{subfigure}[b]{0.49\textwidth}
		\centering
		\includegraphics[width=.27\textheight]{figure18b.png}
		\caption{\centering Model-\RNum{2}, \(IoU\) = \(0.23\)} 
