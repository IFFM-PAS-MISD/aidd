...
\begin{sloppypar}
	...
	The \(\delta\) parameter was introduced to avoid delamination occurrence at the centre of the plate where a PZT actuator is located.
	\begin{figure}[!ht]
		\centering
	...
	and combined to final damage map by using the RMS, where \(N\) represents 
	the total number of samples in a single delamination case:
