...
In this chapter, we discussed that structures wether are civil (e.g. buildings, bridges, etc)or aeronautic (e.g. in composite materials) are ageing in time,  and are exposed to have several types of damage. 
...
Accordingly, to avoid these consequences SHM techniques could be applied.  
...
In this chapter,  several SHM approaches for detecting and localising damage within composite structures that utilising guided Lamb waves were presented. 
...
Accordingly, we concluded that those traditional techniques are complex and involve a huge numerical analysis and signal processing. Which concluded that the damage features are difficult to be extracted manually. 
Accordingly, new approaches that involve Machine and Deep Learning techniques are utilised are presented in this chapter. 
As a result, the process of damage features extracting became more convenient and easier since the machine is responsible for learning the new features and accordingly detects and localising the damage. 
Therefore we concluded that the advantage of this approach is the scalability. 
