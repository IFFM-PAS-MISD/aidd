...
For this purpose, vibration techniques are utilised which can be classified as the signal-based and the model-based.
...
to detect and localise damage in the structure by utilising relations 
