...
In Structural health monitoring, Guided waves are essentially elastic waves 
propagating within bounded structures\cite{Mitra2016}, due to the fact that 
there is no such 
infinite plane, accordingly, they are being guided by the structure's 
boundaries.
Various sorts of guided waves have been investigated for the
purpose of SHM. 
...
forms are symmetric, denoted as S0,S1,S2,...., and  and asymmetric, denoted as 
A0,A1,A2,...., \cite{Ostachowicz2012}. Fig 1.2 presents Lamb wave for S0  and 
A0 modes\cite{Willberg2015}.

\begin{figure} [h!]
	\begin{center}
		\includegraphics[width=14cm]{Graphics/Figure1_2_Lamb_wave.jpg}
	\end{center}
...
sensitivity of Lamb waves toward structural perturbations. Moreover, noise 
arising from environmental sources, like temperature changing, or anisotropy of 
the material also summed up to the received signals making them very 
complicated and difficult to recognize and interpret\cite{Willberg2015}.
