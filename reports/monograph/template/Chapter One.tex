...
global schemes. Local schemes were discussed in~\cite{Grimberg2001,Maldague1993,Raghavan2007}
...
vibration techniques are utilized. 
In which, two types of techniques are 
introduced, the signal based 
and the model-based.
...
The model-based approaches use various types of models for a monitored structure 
