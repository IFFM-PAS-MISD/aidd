...
\paragraph{} 
One interesting  method for SHM in composite materials is the use of Guided 
waves which are essentially elastic waves propagating within bounded 
structures\cite{Mitra2016}, due to the fact that there is no such 
infinite plane, accordingly, they are being guided by the structure's 
boundaries.
Various sorts of guided waves have been investigated for the purpose of SHM. 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Damage Detection and Localization in SHM }
