...
\begin{itemize}
	\item Fiber-reinforced composite materials that consist of three parts: the 
	fibers as the dispersed phase, the matrix as the continuous phase, and the 
	fine inter-phase region, also known as the interface~\cite{Cantwell1991}.
	\item Laminated composite materials that are an assembly of layers of 
	fiber-reinforced composite material that can be combined to implement 
...
produced waves are traveling in packets, those packets keep propagating until 
...
wave mode which cause a problem with reflection identification and 
...
performance of the system~\cite{Farrar2012}. 
