...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Almost all government and private industries are interested in detecting damage in their products and in their manufacturing structure at the earliest feasible time. These industries carry out some form of SHM for such detection\cite{Farrar2007}. The main aim of the SHM system is to maintain good information on the state of the inspected structure for the purpose of finding structural defects before they reach critical levels. It also helps in providing adequate information for condition-based maintenance.
